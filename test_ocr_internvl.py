...
import torch
from chemexam_repo.ChemLLM_Multimodal_Exam.internvl.model.internvl_chat import InternVLChatModel
from chemexam_repo.ChemLLM_Multimodal_Exam.internvl.train.dataset import (ConcatDataset, TCSLoader,
...
def evaluate_chat_model():
    ...
    for ds_name in args.datasets:
        ...
        results_file = 'smiles_ocr_2b_' + model_id + '_' + ds_name +'.jsonl'
