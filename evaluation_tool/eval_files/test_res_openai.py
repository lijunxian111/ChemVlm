...
## Note that "eval_env" environment is needed for this page !!!!!!
...
ds_collections = {
    ...
    'orderly_product':{
       'root': '',
       'question': '/mnt/petrelfs/zhangdi1/lijunxian/datagen/orderly_test_project.jsonl',
    ...
    'seed':{
       'root': '',
       'question': '/mnt/petrelfs/zhangdi1/lijunxian/datagen/seed_test.jsonl',
       'prompt': "Please answer A, B, C or D according to the question. You should only answer a capital letter.",
       'max_new_tokens': 100,
       'min_new_tokens': 1,
    },
    ...
    'mmbench':{
       'root': '',
       'question': '/mnt/hwfile/ai4chem/wangweida/data/MMBench/mmbench_dev.jsonl',
       'prompt': "Please answer A, B, C or D according to the question. You should only answer a capital letter.",
       'max_new_tokens': 100,
       'min_new_tokens': 1,
    },
    'realworldqa':{
       'root': '',
       'question': '/mnt/hwfile/ai4chem/CVPR/realworldqa/json/generated_data.jsonl',
    ...
    'math_vista':{
       'root': '',
       'question': '/mnt/hwfile/ai4chem/wangweida/data/MathVista/mathvista_testmini.jsonl',
       'prompt': "Your answer format should be ```{Answer: }```",
       'max_new_tokens': 100,
       'min_new_tokens': 1,
    },
...
openai.api_key = 'sk-AFgqhX1yg2X0L8DTF068CeCdDa3b4082A64fB96cBa7aF9D8'
...
def call_multimodal(model_name, image_path, text):
    ...
    if "qwen" in model_name:
        ...
        #client = OpenAI(api_key='sk-kHGxnk8OptzWhewzmcA0TCuLd2XtR8gXKqEevcUhQ0D9yJYs', base_url="https://api.claudeshop.top/v1")   #CVPR
        client = OpenAI(api_key='sk-CDgTXzUtECTUk5OIo8tsE00XF5kmyzM7DWSJdfdgLfvY2lKr', base_url="https://api.claudeshop.top/v1")  #ChemVLM
        #client = OpenAI(api_key='sk-AFgqhX1yg2X0L8DTF068CeCdDa3b4082A64fB96cBa7aF9D8', base_url="https://api.claudeshop.top/v1")
        ...
        client = OpenAI(api_key='0832fa4dbe0642efbd01ebcee4debe01', base_url="https://api.lingyiwanwu.com/v1")
        #client = OpenAI(api_key='58073c26cafa4775b7449769ee3bd5c7', base_url="https://api.lingyiwanwu.com/v1")
        messages = [{"role": "user", "content": [{"type": "text", "text": text}]}]
        ...
        genai.configure(api_key='FBY245kK7Ye10kPiE3ME48T6vXxgcAtnMO8jhdSK9Qe4SdG0')
        image = Image.open(image_path)
        ...
        client = ZhipuAI(api_key="06cfd38846f9f99134979697c6077e5f.ZXIRvlPKhSLDKdLl") # APIKey
        base64_image = encode_image(image_path)
        try:
            img_type = get_image_extension(image_path)[1:]
        except:
...
if __name__ == "__main__":
    #TODO: CMMU + Yi
    #call_multimodal('gemini-1.5-pro', '/mnt/hwfile/ai4chem/share/chemqa/test/7.jpg', 'What is in this picture?')
    ...
    if "llava" in model_names:
        ...
        command = "srun -p AI4Phys --gres=gpu:1 python /mnt/petrelfs/zhangdi1/lijunxian/LLaVA/vqn_chem.py"
        ...
        #generate_answers("/mnt/petrelfs/zhangdi1/lijunxian/LLaVA/llava-v1.5-13b", ds_collections[dataset_name]['question'], ds_collections[dataset_name]['question']['root'], f'./{model_name}-{dataset_name}.jsonl')
    #else:
